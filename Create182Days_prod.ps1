...
$newPolicyFeatureXml = "<p:Policy xmlns:p='office.server.policy' local='false' id='a00e2ae1-83b2-4425-80a0-5e16e34e193c'>"+
"<p:Name>days182</p:Name>"+
"<p:Description>days182</p:Description>"+
"<p:Statement />"+
"<p:PolicyItems>"+
"<p:PolicyItem featureId='Microsoft.Office.RecordsManagement.PolicyFeatures.Expiration' UniqueId='4573216e-6a9e-407b-81e2-aace9673d632'>"+
...
Create182Days -siteURL "https://services2013.dtek.com/sites/mobileworkers/mines" -listName $i1 -contentType “Document”
