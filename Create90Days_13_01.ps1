...
$newPolicyFeatureXml = "<p:Policy xmlns:p='office.server.policy' local='false' id='718d1dc2-10a4-4b8b-b672-40890c45a6f8'>"+
"<p:Name>delete90</p:Name>"+
"<p:Description>delete90</p:Description>"+
"<p:Statement />"+
"<p:PolicyItems>"+
"<p:PolicyItem featureId='Microsoft.Office.RecordsManagement.PolicyFeatures.Expiration' UniqueId='e90447b9-553e-4e1e-be75-4f61cee5314d'>"+
...
Create90Days -siteURL "http://services2013-t01.dtek.com/mobileworkers/grids" -listName $i1 -contentType “Document”
...
#Call the function to create a library
Create90Days -siteURL "http://services2013-t01.dtek.com/mobileworkers/mines" -listName $i2 -contentType “Document”
