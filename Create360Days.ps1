...
$newPolicyFeatureXml = "<p:Policy xmlns:p='office.server.policy' local='false' id='559dc5bd-ef8b-4289-8385-b16f60c4c835'>"+
"<p:Name>delete360</p:Name>"+
"<p:Description>delete360</p:Description>"+
"<p:Statement />"+
"<p:PolicyItems>"+
"<p:PolicyItem featureId='Microsoft.Office.RecordsManagement.PolicyFeatures.Expiration' UniqueId='6df41582-2e4c-43f3-84c9-d62e21041dc0'>"+
...
Create360Days -siteURL "https://services2013-t02.dtek.com/sites/mobileworkers/pwg" -listName $i1 -contentType “Document”
