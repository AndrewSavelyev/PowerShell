...
function Create182Days($siteURL, $listName, $contentType)
{
#Get web object
...
$newPolicyFeatureXml = "<p:Policy xmlns:p='office.server.policy' local='false' id='53e1ede7-4fb7-4531-b47b-7134cc004c42'>"+
"<p:Name>delete182</p:Name>"+
"<p:Description>delete182</p:Description>"+
"<p:Statement />"+
"<p:PolicyItems>"+
"<p:PolicyItem featureId='Microsoft.Office.RecordsManagement.PolicyFeatures.Expiration' UniqueId='6f58eb8e-bcff-412c-bfb9-a7e44b6de4e3'>"+
...
$list1 = @('Sh_Yubileynaya_Defekt','Sh_Geroev_Kosmosa_Defekt','Sh_Zapadno_Donbasskaya_Defekt')
...
Create182Days -siteURL "https://services2013-t02.dtek.com/sites/mobileworkers/mines" -listName $i1 -contentType “Document”
