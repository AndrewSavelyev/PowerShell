...
$newPolicyFeatureXml = "<p:Policy xmlns:p='office.server.policy' local='false' id='9f225b36-a3f8-43d8-ac51-26730ddeb572'>"+
"<p:Name>delete360</p:Name>"+
"<p:Description>delete360</p:Description>"+
"<p:Statement />"+
"<p:PolicyItems>"+
"<p:PolicyItem featureId='Microsoft.Office.RecordsManagement.PolicyFeatures.Expiration' UniqueId='a428aebf-9bd8-406e-8a21-4d58fb8747f6'>"+
...
"<period>days</period>"+
"</formula>"+
"<action type='action' id='Microsoft.Office.RecordsManagement.PolicyFeatures.Expiration.Action.Delete' />"+"</data>"+
"</stages>"+
"</Schedule>"+
"</Schedules>"+
"</p:CustomData>"+
