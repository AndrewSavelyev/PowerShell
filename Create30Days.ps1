...
$lists = @('DnES_Dokumentatsiya','DnES_Dopusk','DnES_Podtverzhdeniya')
...
Create30Days -siteURL “https://services2013-t02.dtek.com/sites/mobileworkers” -listName $i -contentType “Document”
